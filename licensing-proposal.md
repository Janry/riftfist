# Licensing Proposal — Rick and Morty Beat 'em Up Game

> Draft pitch letter to the rights holder (Warner Bros. Discovery / Adult Swim).
> Replace every `[bracketed]` field before sending. Keep it to one page.

---

## English version (primary — this is who you're writing to)

**Subject:** Licensing inquiry — original mobile beat 'em up based on *Rick and Morty*
...
**Why this fits the brand.** *Rick and Morty*'s dimension-hopping is a perfect structural match for the genre, and the show's tone (sharp, absurd, character-driven) lends itself to memorable enemies and boss fights. The aim is a polished, faithful product that fans recognize and respect — not a quick cash-in.

**Traction.** I already have a working, playable browser prototype that validates the core game feel: depth-based movement, a three-hit combo chain with hitstop and screenshake, jumping and aerial attacks, pick-up weapons with throws, knockdowns, and a full level arc (intro → waves → mini-boss → boss). I can share a private link or a build for your review on request.
...
## Українська версія (для себе / на випадок україномовного контакту)

**Тема:** Запит на ліцензію — оригінальна мобільна beat 'em up гра за всесвітом *Rick and Morty*
...
**Чому це пасує бренду.** Подорожі по вимірах структурно ідеальні для жанру, а тон серіалу дає яскравих ворогів і босів. Мета — якісний, поважний до фанатів продукт, а не «швидкий заробіток».

**Що вже є.** Робочий ігровий браузерний прототип, який підтверджує відчуття гри: рух у глибину, комбо з hitstop і трясінням екрана, стрибки й повітряні удари, зброя з кидком, knockdown, повний цикл рівня (вступ → хвилі → міні-бос → бос). За запитом надам приватне посилання чи білд.

**Прохання.** Буду радий обговорити умови ліцензії — роялті/revenue share, процес погодження, ваші бренд- і контент-гайдлайни. Готовий повністю працювати в межах вашого креативного контролю та стандартів якості.
